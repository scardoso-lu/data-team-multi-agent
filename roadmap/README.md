...
| 9 — Filesystem workspace | 4 |
| 10 — Code & command execution | 4 |
| 11 — Agent delegation & subagents | 4 |
| 12 — In-agent task planning | 4 |
| 13 — MCP integration | 4 |
| 14 — Provider registry & model swapping | 4 |
| **Total** | **61** |
