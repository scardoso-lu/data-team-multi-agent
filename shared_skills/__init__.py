...
# This module contains hot-reloadable skills for all agents.
# Agents will dynamically import skills from this directory.
...
class SkillLoader:
    ...
    def __init__(self, skills_dir="shared_skills"):
